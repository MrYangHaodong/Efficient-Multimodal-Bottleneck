"""CrossAttnV6Clf fusion baseline on PAMAP2.

Fair model-swap counterpart of ``main_v6_pamap2_fusion_only_dyna.py``:
identical data pipeline (HARDataset, PAMAP2 config, ``transform='sax'``,
...
Run:
    python script/main_crossattn_v6_pamap2.py --fold=0 --cuda_pick=cuda:0
    python script/main_crossattn_v6_pamap2.py --aggregate
"""
...
# v6_organized root for HARDataset / PAMAP2 cfg / train_utils.
