"""DynMM / DyMo on MOSEI, V6 backbone (2-layer per-modality encoder +
4-layer bottleneck fusion) reused as the modality-subset encoder/fusion.

MOSEI sibling of `main_dynmm_dymo_daliahar_late_fusion.py`.
...
Run:
    python main_dynmm_dymo_mosei_late_fusion.py --method dynmm --fold 0 --cuda_pick cuda:0
    python main_dynmm_dymo_mosei_late_fusion.py --method dymo  --fold 0 --cuda_pick cuda:0
    python main_dynmm_dymo_mosei_late_fusion.py --method dynmm --aggregate
"""
...
parser = argparse.ArgumentParser(
    description='DynMM / DyMo on MOSEI (V6 2-enc + 4-fusion backbone).')
...
parser.add_argument('--results_dir', default='./results_dynmm_dymo_mosei/', type=str)
...
# cross-modal fusion. MOSEI feeds a feats-list; the MOSEI wrappers concat
