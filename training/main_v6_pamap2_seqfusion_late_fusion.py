...
train_ds = load_pamap2_subjects(dataset_cfg.cross_subject_dir, modalities, train_subjects, dataset_cfg, args.transform, sax_params=sax_params)
val_ds = load_pamap2_subjects(dataset_cfg.cross_subject_dir, modalities, val_subjects, dataset_cfg, args.transform, sax_params=sax_params)
eval_ds = load_pamap2_subjects(dataset_cfg.cross_subject_dir, modalities, eval_subjects, dataset_cfg, args.transform, sax_params=sax_params)
