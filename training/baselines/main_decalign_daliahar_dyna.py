...
parser.add_argument('--exp_name', default='decalign_daliahar_dyna', type=str)
parser.add_argument('--results_dir',
                    default='./results_decalign_daliahar_dyna/', type=str)
...
# Input transform aligned to the rest of the suite (crossattn/dymo/multimodn/
# seqA all use SAX on DaliaHAR).  word_length=2 -> input_length=(T_raw)//2,
# matching HARDataset's SAX tokenisation.
...
config = {
    ...
    'model_variant': 'decalign_daliahar_dyna',
