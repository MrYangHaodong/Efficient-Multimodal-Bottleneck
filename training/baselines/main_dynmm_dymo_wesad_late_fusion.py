"""DynMM / DyMo on WESAD, V6 backbone (2-layer per-modality encoder +
...
Run:
    python main_dynmm_dymo_wesad_late_fusion.py --method dynmm --fold 0 --cuda_pick cuda:0
    python main_dynmm_dymo_wesad_late_fusion.py --method dymo  --fold 0 --cuda_pick cuda:0
    python main_dynmm_dymo_wesad_late_fusion.py --method dynmm --aggregate
"""
...
parser = argparse.ArgumentParser(
    description='DynMM / DyMo on WESAD (V6 2-enc + 4-fusion backbone).')
...
parser.add_argument('--results_dir', default='./results_dynmm_dymo_wesad/', type=str)
