"""MultiModN baseline training on DaliaHAR with the V6 **dyna**
...
DaliaHAR specifics mirror ``main_flexmoe_daliahar_dyna.py``:
  * SAX tokenisation (``input_mode='sax'``).
  * Subject-disjoint 3-fold cross-validation (``--fold``); the DaliaHAR
...
Run:
    python main_multimodn_daliahar_dyna.py --fold=0 --cuda_pick=cuda:0 \
        --num_layers=2 --num_layers_fus=4
    python main_multimodn_daliahar_dyna.py --aggregate
"""
...
parser = argparse.ArgumentParser(
    description='MultiModN on DaliaHAR with V6 grad-norm dyna modality-drop.')

parser.add_argument('--exp_name', default='multimodn_daliahar_dyna', type=str)
parser.add_argument('--results_dir',
                    default='./results_multimodn_daliahar_dyna/', type=str)
...
# MultiModN on DaliaHAR uses SAX tokenisation. Structure aligned to V6:
...
config = {
    ...
    'model_variant': 'multimodn_daliahar_dyna',
