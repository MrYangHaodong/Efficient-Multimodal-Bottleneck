"""QMF / PDF confidence-weighted **late fusion** on DaliaHAR.

Reuses the same V6 backbone (`DualVideoBottleneckModelV6Downsample`,
`no_selector=True`) as `main_v6_daliahar_fusion_only_dyna_late_fusion.py`,
...
Run:
    python main_qmfpdf_daliahar_late_fusion.py --fusion_method qmf --fold 0 --cuda_pick cuda:0
    python main_qmfpdf_daliahar_late_fusion.py --fusion_method pdf --fold 0 --cuda_pick cuda:0
    python main_qmfpdf_daliahar_late_fusion.py --fusion_method qmf --aggregate
"""
...
parser = argparse.ArgumentParser(
    description='QMF / PDF confidence-weighted late fusion on DaliaHAR.')
...
parser.add_argument('--results_dir', default='./results_qmfpdf_daliahar/', type=str)
