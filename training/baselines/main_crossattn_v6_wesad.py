"""CrossAttnV6Clf fusion baseline on WESAD.

Fair model-swap counterpart of ``main_v6_wesad_fusion_only_dyna.py``:
identical data pipeline (HARDataset, WESAD config, ``transform='sax'``,
...
Run:
    python script/main_crossattn_v6_wesad.py --fold=0 --cuda_pick=cuda:0
    python script/main_crossattn_v6_wesad.py --aggregate
"""
...
# v6_organized root for HARDataset / WESAD cfg / train_utils.
