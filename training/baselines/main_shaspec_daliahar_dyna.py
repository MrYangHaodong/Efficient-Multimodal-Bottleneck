"""ShaSpec baseline training on DaliaHAR with the V6 **dyna**
(grad-norm-based asymmetric modality-dropout) curriculum.

Schedule mirrors ``main_v6_daliahar_fusion_only_dyna.py``:
...
fusion + domain classifier).  Uses SAX tokens for DaliaHAR.

Run:
    python main_shaspec_daliahar_dyna.py --fold=0 --cuda_pick=cuda:0
    python main_shaspec_daliahar_dyna.py --aggregate
"""
...
parser = argparse.ArgumentParser(
    description='ShaSpec on DaliaHAR with V6 grad-norm dyna modality-drop.')

parser.add_argument('--exp_name', default='shaspec_daliahar_dyna', type=str)
parser.add_argument('--results_dir',
                    default='./results_shaspec_daliahar_dyna/', type=str)
...
# ShaSpec on DaliaHAR uses SAX tokenisation (matches paper recipe).
...
config = {
    ...
    'model_variant': 'shaspec_daliahar_dyna',
