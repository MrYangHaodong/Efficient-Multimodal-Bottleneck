...
router + experts soft-combine the prediction. Ported here to CMU-MOSEI (3 modalities:
vision/audio/text time-series, SINGLE task = Acc-2 sentiment), so:
  ...
  * each modality is first encoded to an embedding (transformer encoder + mean-pool),
    matching our other MOSEI baselines, then routing/experts operate in embedding space.
