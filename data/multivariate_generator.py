...
if __name__ == '__main__':
    ...
    df.to_csv("/home/payal/maestro_ttn_robustness/data/synth_data/basic_multivariate/train_test.csv", index=False)
    ...
    plt.savefig("/home/payal/maestro_ttn_robustness/data/synth_data/basic_multivariate/01234.jpg")
    plt.show()
