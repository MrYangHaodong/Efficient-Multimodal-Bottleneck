#!/usr/bin/env python
"""Aggregate CMU-MOSEI 3-seed runs under results_mosei_3seed/.
...
RD = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'results_mosei_3seed')
TAGS = ['seqA', 'crossattn', 'shaspec', 'multimodn', 'decalign', 'dymo']
...
def main():
    ...
    out = os.path.join(RD, 'summary_3seed.json')
