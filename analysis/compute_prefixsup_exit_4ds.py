...
order; sweep each scheme's threshold -> (meanK, acc, f1). Output -> seqA_prefixsup_exit_schemes_4ds.json
...
def run_dataset(ds):
    seqa_dir = sorted(glob.glob(os.path.join(_ROOT, 'results_3p3', 'seqA_prefixsup', ds, '*')))[0]
...
json.dump(out, open(os.path.join(_ROOT, 'results_3p3', 'seqA_prefixsup_exit_schemes_4ds.json'), 'w'), indent=2)
print('saved -> results_3p3/seqA_prefixsup_exit_schemes_4ds.json')
np.savez(os.path.join(_ROOT, 'results_3p3', 'seqA_prefixsup_exit_signals_raw_4ds.npz'), **RAW)
print('saved -> results_3p3/seqA_prefixsup_exit_signals_raw_4ds.npz')
